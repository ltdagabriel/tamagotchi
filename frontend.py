...
def UpdateTamagotchi(tamagotchi):
    if tamagotchi:
        ...
        if( 30*60 < int(deltaTime) < 60*60):
            ...
            poke = getPokemon(tamagotchi.name_pokemon, tamagotchi.user_id)
            if poke == None:
                Pokemon1 = Pokemon(tamagotchi.name_pokemon, tamagotchi.user_id, True)
                s.add(Pokemon1)
